...
export IMAGE_URL=${IMAGE_URL-rhtap-quay-quay-rhtap-quay.apps.rhopp241121.devcluster.openshift.com/rhtap/goapp:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhopp-rhtap-testing/goapp-241121-gitops
